...
otp.config.modes = {
    ...
    "CAR_PARK_PICKUP,TRANSIT"  : _tr('Last mile Ride and Park'),
    "CAR_PARK_PICKUP_DROPOFF,TRANSIT"     : _tr('First and Last mile Park and Ride'),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel Options widgets)
    ...
    "BICYCLE_PARK_PICKUP_DROPOFF,TRANSIT" : _tr('First and Last mile Bike and Ride'),
