...
otp.config.modes = {
    ...
    "CAR_PICKUP"               : _tr('Taxi'),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel Options widgets)
    "CAR_PARK"                 : _tr('Park and Ride (dropoff)'),
    "CAR_PARK_PICKUP"          : _tr('Park and Ride (pickup)'),
    ...
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel Options widgets)
    "BICYCLE_PARK"             : _tr('Bicycle Park (dropoff)'),
    "BICYCLE_PARK_PICKUP"      : _tr('Bicycle Park (pickup)'),
    "BICYCLE_PARK,TRANSIT"                : _tr('First mile Bike and Ride'),
    "BICYCLE_PARK_PICKUP,TRANSIT"         : _tr('Last mile Bike and Ride'),
    "BICYCLE_PARK_DROPOFF_PICKUP,TRANSIT" : _tr('First and Last mile Bike and Ride'),
