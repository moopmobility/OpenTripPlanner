...
public class FlexRouter {
  ...
  public FlexRouter(
    ...
    if (graph.hasStreets) {
      this.accessFlexPathCalculator = new StreetFlexPathCalculator(graph, false, config);
      this.egressFlexPathCalculator = new StreetFlexPathCalculator(graph, true, config);
    } else {
